...
(function (document) {
  ...
  FancyUtils.on(document, "objectNeedsType.fb", function (e, instance, item) {
    ...
    var url = item.src || "",
        ...
        paramObj,
        provider;
    media = Object.assign({}, FancyMediaDefaults, item.opts.media); // Look for any matching media type

    Object.entries(media).some(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
          providerName = _ref2[0],
          providerOpts = _ref2[1];
      ...
      url = FancyUtils.isFunction(providerOpts.url) ? providerOpts.url.call(_this2, rez, params, item) : format(providerOpts.url, rez, params);
      thumb = FancyUtils.isFunction(providerOpts.thumb) ? providerOpts.thumb.call(_this2, rez, params, item) : format(providerOpts.thumb, rez);
...
(function (document) {
  ...
  FancyDefaults.btnTpl.slideShow = '<button data-fancybox-play class="fancybox-button fancybox-button--play" title="{{PLAY_START}}">' + '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6.5 5.4v13.2l11-6.6z"/></svg>' + '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M8.33 5.75h2.2v12.5h-2.2V5.75zm5.15 0h2.2v12.5h-2.2V5.75z"/></svg>' + "</button>";
  ...
  Object.assign(SlideShow.prototype, {
    ...
    init: function init() {
      ...
      FancyUtils.on(this.instance.$refs.toolbar, "click", "[data-fancybox-play]", function () {
        _this.toggle();
      });
    },
    ...
    start: function start() {
      ...
      if (current) {
        self.$button.setAttribute("title", (current.opts.i18n[current.opts.lang] || current.opts.i18n.en).PLAY_STOP);
    ...
    stop: function stop() {
      var self = this,
          current = self.instance.current;
      self.clear();
      self.$button.setAttribute("title", (current.opts.i18n[current.opts.lang] || current.opts.i18n.en).PLAY_START);
